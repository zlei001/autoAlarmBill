 ...
 *
 */
@Service("com.cattsoft.eomsteam.iot.alarm.pending.bill.fault.busi.TwoLevelCellPendingFaultBillBusiService") 
public class TwoLevelCellPendingFaultBillBusiService extends AbsCellFaultBillBusiService {
	...
	public void doBusi() {
	    ...
	    List<TbAlarmPendingEntity> alarmPendingEntityList = tbAlarmPendingService.getAlarmPendingByCellTwoLevel();
	    logger.info("二级小区告警:"+alarmPendingEntityList.size());
