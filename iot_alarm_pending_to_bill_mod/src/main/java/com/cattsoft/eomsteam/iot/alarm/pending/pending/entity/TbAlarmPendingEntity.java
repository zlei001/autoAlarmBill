package com.cattsoft.eomsteam.iot.alarm.pending.pending.entity;

import java.io.Serializable;

public class TbAlarmPendingEntity implements Serializable {

	/**
	 * ÏµÁÐ»¯
	 */
	private static final long serialVersionUID = -2805176823110858086L;
	...
	private Integer I_OBJ_SOURCE;
	private Integer I_DISPATCH_FLAG;
	private Integer I_RESET_FLAG;
	private Integer I_CANCEL_FLAG;
	...
	public Integer getI_OBJ_SOURCE() {
		return I_OBJ_SOURCE;
	}
	public Integer getI_DISPATCH_FLAG() {
		return I_DISPATCH_FLAG;
	}
	public Integer getI_RESET_FLAG() {
		return I_RESET_FLAG;
	}
	public Integer getI_CANCEL_FLAG() {
		return I_CANCEL_FLAG;
	}
	...
	public void setI_OBJ_SOURCE(Integer i_OBJ_SOURCE) {
		I_OBJ_SOURCE = i_OBJ_SOURCE;
	}
	public void setI_DISPATCH_FLAG(Integer i_DISPATCH_FLAG) {
		I_DISPATCH_FLAG = i_DISPATCH_FLAG;
	}
	public void setI_RESET_FLAG(Integer i_RESET_FLAG) {
		I_RESET_FLAG = i_RESET_FLAG;
	}
	public void setI_CANCEL_FLAG(Integer i_CANCEL_FLAG) {
		I_CANCEL_FLAG = i_CANCEL_FLAG;
	}
