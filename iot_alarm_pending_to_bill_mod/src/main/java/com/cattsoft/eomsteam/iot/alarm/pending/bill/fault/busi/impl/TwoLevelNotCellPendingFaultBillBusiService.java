 ...
 *
 */
@Service("com.cattsoft.eomsteam.iot.alarm.pending.bill.fault.busi.TwoLevelNotCellPendingFaultBillBusiService") 
public class TwoLevelNotCellPendingFaultBillBusiService extends AbsNotCellFaultBillBusiService {
	...
	public void doBusi() {
		...
		List<TbAlarmPendingEntity> alarmPendingEntityList = tbAlarmPendingService.getAlarmPendingByNotCellTwoLevel();
		logger.info("二级非小区告警:"+alarmPendingEntityList.size());
