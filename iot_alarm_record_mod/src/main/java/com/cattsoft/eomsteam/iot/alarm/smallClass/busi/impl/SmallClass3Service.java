...
@Service("com.cattsoft.eomsteam.iot.alarm.smallClass.3")
public class SmallClass3Service extends AbsSmallClassService {
    ...
    public List<Map<String,Object>> faultApn(  String code,String time, String cycle) {
        ...
        List<Map<String,Object>> res =failCodeDao.getS1Top5Fail(valueMap);
        return res;
    }
