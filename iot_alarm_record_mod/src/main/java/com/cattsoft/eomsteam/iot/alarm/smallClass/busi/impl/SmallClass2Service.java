...
@Service("com.cattsoft.eomsteam.iot.alarm.smallClass.2")
public class SmallClass2Service extends AbsSmallClassService {
    ...
    public List<Map<String,Object>> faultApn(  String code,String time, String cycle) {
        ...
        List<Map<String,Object>> res =failCodeDao.getPdnTop5Fail(valueMap);
        return res;
    }
