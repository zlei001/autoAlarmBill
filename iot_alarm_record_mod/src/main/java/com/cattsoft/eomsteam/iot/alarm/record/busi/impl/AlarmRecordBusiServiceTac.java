...
@Service("com.cattsoft.eomsteam.iot.alarm.record.busi.2") 
public class AlarmRecordBusiServiceTac extends AbsAlarmRecordBusiService {
	...
	protected String getS_TITLE(Map<String, Object> pending, TbAlarmConfigEntity tbDelimitedConfigEntity, TbAlarmConfigLogEntity tbDelimitedConfigLogEntity) {
		StringBuffer str = new StringBuffer();
		str.append("¡¾TAC:").append(mapName(pending)).append("¡¿").append(tbDelimitedConfigEntity.getS_TITLE()).append(" ");
		return str.toString();
	}
