...
@Service("com.cattsoft.eomsteam.iot.alarm.smallClass.4")
public class SmallClass4Service extends AbsSmallClassService {
    ...
    public List<Map<String,Object>> faultApn(  String code,String time, String cycle) {
        ...
        List<Map<String,Object>> res =failCodeDao.getX2Top5Fail(valueMap);
        return res;
    }
    ...
    faultTmnl(  String code,String time, String cycle) {
        Map<String,Object> valueMap= new HashMap<String,Object>();
        if (cycle.equals("1")) {
