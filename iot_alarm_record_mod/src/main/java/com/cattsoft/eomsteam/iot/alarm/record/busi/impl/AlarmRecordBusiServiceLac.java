...
@Service("com.cattsoft.eomsteam.iot.alarm.record.busi.7")
public class AlarmRecordBusiServiceLac extends AbsAlarmRecordBusiService {
	...
	protected String getS_TITLE(Map<String, Object> pending, TbAlarmConfigEntity tbDelimitedConfigEntity, TbAlarmConfigLogEntity tbDelimitedConfigLogEntity) {
		StringBuffer str = new StringBuffer();
		str.append("¡¾LAC:").append(mapName(pending)).append("¡¿").append(tbDelimitedConfigEntity.getS_TITLE()).append(" ");
		return str.toString();
	}
